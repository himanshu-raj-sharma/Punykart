...
export const ImpactBanner: React.FC = () => {
  return (
    <section className="py-4 px-3.5 sm:px-4 bg-[#F8FAFC]">
      <div className="max-w-md sm:max-w-lg md:max-w-xl mx-auto">
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-r from-[#FFFDF7] via-[#FFF9EC] to-[#FFFDF7] border border-[#FDE68A]/70 rounded-2xl p-4 sm:p-5 shadow-xs overflow-hidden"
        >
          
          <div className="flex items-center justify-between gap-2">
            
            {/* Left Graphic: Glowing Heart with sparkle */}
            <div className="w-12 h-12 sm:w-14 sm:h-14 flex-shrink-0 flex items-center justify-center rounded-2xl bg-orange-100/70 border border-orange-200 shadow-inner">
            ...
            <div className="flex-1 text-center px-1 sm:px-2 min-w-0">
              ...
              {/* Eyebrow */}
              <div className="flex items-center justify-center gap-1 text-[10px] sm:text-[11px] font-black text-amber-700 uppercase tracking-widest mb-1">
              ...
              {/* Headline */}
              <h3 className="font-display font-black text-sm sm:text-base text-[#0B1B2B] leading-snug">
